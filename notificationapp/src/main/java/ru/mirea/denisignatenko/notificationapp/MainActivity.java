package ru.mirea.denisignatenko.notificationapp;
...
import ru.mirea.denisignatenko.notificationapp.R;

public class MainActivity extends AppCompatActivity {
    private static final String CHANNEL_ID = "com.mirea.ignatenko.notification.ANDROID";
